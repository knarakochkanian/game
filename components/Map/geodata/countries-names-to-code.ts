...
export const countriesNamesToCode: Record<string, string> = {
  ...
  "Ганьсу": "CN.GS",
  "Гуандун": "CN.GD",
  "Гуанси-Чжуанский автономный район": "CN.GX",
  "Гуйчжоу": "CN.GZ",
  "Хайнань": "CN.HA",
  "Хэбэй": "CN.HB",
  "Хэйлунцзян": "CN.HL",
  ...
  "Цзилинь": "CN.JL",
  "Ляонин": "CN.LN",
  "Нинся-Хуэйский автономный район": "CN.NX",
  "Цинхай": "CN.QH",
  "Шаньси": "CN.SA",
  "Шаньдун": "CN.SD",
  "Шанхай": "CN.SH",
  ...
  "Сычуань": "CN.SC",
  "Тяньцзинь": "CN.TJ",
  "Синьцзян-Уйгурский автономный район": "CN.XJ",
  ...
  "Республика Крым и Севастополь": "RU-CRM",
