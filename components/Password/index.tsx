...
interface PasswordProps {
  setIsPasswordPassed: (passed: boolean) => void;
}

export default function Password({ setIsPasswordPassed }: PasswordProps) {
  ...
  useEffect(() => {
    if (password === '111285') {
      ...
      window.localStorage.setItem('isPasswordPassed', 'true');
