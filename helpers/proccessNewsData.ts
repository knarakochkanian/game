import {
  getDayAndMonthAbbr,
  getRandomChannelLogo,
  getRandomNewsPic,
  getTopCapitalizationNews,
  joinStrings,
} from './helpers_1';
...
const getNewsData = (
  ...
  return {
    ...
    VPK: [
      ...
      {
        contentInDetails: `Крупномасштабная кибератака на военно-промышленные комплексы ${countriesStr}`,
        imgSrc: getRandomNewsPic(),
        channelLogoSrc: getRandomChannelLogo(),
      ...
      {
        contentInDetails: `${countriesStr} на прицеле хакерской армии в исторической по масштабам кибератаке`,
        imgSrc: getRandomNewsPic(),
        channelLogoSrc: getRandomChannelLogo(),
    ...
    GOS_INFRASTRUCTURES: [
      {
        contentInDetails: `Шифровальщики объединились против правительств лидеров ${countriesStr}`,
        imgSrc: getRandomNewsPic(),
        channelLogoSrc: getRandomChannelLogo(),
      ...
      {
        contentInDetails: `С началом работы приёмных комиссий хакеры запустили лавину DDoS-атак на вузы`,
        imgSrc: getRandomNewsPic(),
        channelLogoSrc: getRandomChannelLogo(),
        title:
          'Старейшие университеты мира столкнулись с кратным простом кибератак',
        date: formatedDate,
        fullDate: date,
      },
      {
    ...
    MINING: [
      {
        contentInDetails: `Хакеры взламывают системы управления на предприятиях по добыче нефти, газа и других полезных ископаемых. Экономисты прогнозируют большой финансовый кризис.`,
        imgSrc: getRandomNewsPic(),
        channelLogoSrc: getRandomChannelLogo(),
      ...
      {
        contentInDetails: `Произошла кибератака на предприятия по добыче полезных ископаемых. Экспорт нефти и газа остановлен на неопределенное время.`,
        imgSrc: getRandomNewsPic(),
        channelLogoSrc: getRandomChannelLogo(),
    ...
    HEALTHCARE: [
      {
        contentInDetails: `Кибератака на учреждения здравоохранения разрушила логистическую цепочку поставок медикаментов. На решение проблемы уйдет несколько дней.`,
        imgSrc: getRandomNewsPic(),
        channelLogoSrc: getRandomChannelLogo(),
      ...
      {
        contentInDetails: `В отрасли все на ушах. После кибератаки вся финансовая документация организаций оказалась в руках злоумышленников, логистические цепочки работают со сбоями.`,
        imgSrc: getRandomNewsPic(),
        channelLogoSrc: getRandomChannelLogo(),
        title:
          'Хакеры вскрыли финансовую документацию и разрушили логистику здравоохранения',
        date: formatedDate,
        fullDate: date,
      },
      {
        ...
        channelLogoSrc: getRandomChannelLogo(),
        title:
          'Отрасль здравоохранения терпит убытки из-за своей недальновидности',
        date: formatedDate,
        fullDate: date,
      },
    ],
    SPACE: [
      {
        contentInDetails: `Группа хакеров атаковала космическую отрасль, угрожая миссиям на орбите`,
        imgSrc: getRandomNewsPic(),
        channelLogoSrc: getRandomChannelLogo(),
      ...
      {
        contentInDetails: `Хакеры угрожают жизням экипажей и спутниковому оборудованию`,
        imgSrc: getRandomNewsPic(),
        channelLogoSrc: getRandomChannelLogo(),
    ...
    EDUCATION: [
      {
        contentInDetails: `Масштабная кибератака на учреждения образования запустила вредоносную программу в компьютеры. Вылечить их не получится, придется покупать новые.`,
        imgSrc: getRandomNewsPic(),
        channelLogoSrc: getRandomChannelLogo(),
      ...
      {
        contentInDetails: `Массированная кибератака на учебные заведения вывела из строя всю аппаратуру и сделала невозможной проведение занятий.`,
        imgSrc: getRandomNewsPic(),
        channelLogoSrc: getRandomChannelLogo(),
    ...
    INDUSTRY: [
      {
        contentInDetails: `В топливной промышленности произошли масштабные сбои после атаки APT-группировки`,
        imgSrc: getRandomNewsPic(),
        channelLogoSrc: getRandomChannelLogo(),
      ...
      {
        contentInDetails: `Причина — масштабная кибератака на объекты сразу в нескольких странах`,
        imgSrc: getRandomNewsPic(),
        channelLogoSrc: getRandomChannelLogo(),
        title:
          'В головном офисе BMW Group сообщили о приостановке работы заводов',
        date: formatedDate,
        fullDate: date,
      },
      {
        contentInDetails: 'Какие шаги планируют предпринять правительства?',
        imgSrc: getRandomNewsPic(),
        channelLogoSrc: getRandomChannelLogo(),
    ...
    NETWORK_COMUNICATION: [
      {
        contentInDetails: `Руководители крупнейших сетей связи держатся за головы и в панике восстанавливают киберзащиту систем после массированной атаки хакеров.`,
        imgSrc: getRandomNewsPic(),
        channelLogoSrc: getRandomChannelLogo(),
      ...
      {
        contentInDetails: `Хакеры взломали все доступные сети связи. Данные каждого абонента теперь гуляют по интернету.`,
        imgSrc: getRandomNewsPic(),
        channelLogoSrc: getRandomChannelLogo(),
    ...
    SMI: [
      {
        contentInDetails: `Хакеры взломали все СМИ и распространяют недостоверную информацию.`,
        imgSrc: getRandomNewsPic(),
        channelLogoSrc: getRandomChannelLogo(),
      ...
      {
        contentInDetails: `Кибератака на СМИ привела к масштабным сбоям в работе информационных источников по всей стране.`,
        imgSrc: getRandomNewsPic(),
        channelLogoSrc: getRandomChannelLogo(),
        title: 'Хаос в СМИ',
        date: formatedDate,
    ...
    CONSTRUCTION: [
      {
        contentInDetails: `Производства остановлены, компании не могут выполнять свои обязательства — в стране возможен экономический кризис.`,
        imgSrc: getRandomNewsPic(),
        channelLogoSrc: getRandomChannelLogo(),
      ...
      {
        contentInDetails: `После кибератаки нарушены все логистические цепочки, промышленники считают убытки, а подрядчики переносят сроки.`,
        imgSrc: getRandomNewsPic(),
        channelLogoSrc: getRandomChannelLogo(),
    ...
    TRADE: [
      {
        contentInDetails: `Кибератака превращает онлайн-торговлю в поле битвы`,
        imgSrc: getRandomNewsPic(),
        channelLogoSrc: getRandomChannelLogo(),
      ...
      {
        contentInDetails: `Известный маркетплейс стал жертвой кибератаки`,
        imgSrc: getRandomNewsPic(),
        channelLogoSrc: getRandomChannelLogo(),
    ...
    TRANSPORT_SYSTEM: [
      {
        contentInDetails: `Киберпреступники атакуют международные авиакомпании, угрожая мировому воздушному сообщению`,
        imgSrc: getRandomNewsPic(),
        channelLogoSrc: getRandomChannelLogo(),
      ...
      {
        contentInDetails: `Массовая атака на системы грузоперевозок вызвала задержку доставки на 15 дней`,
        imgSrc: getRandomNewsPic(),
        channelLogoSrc: getRandomChannelLogo(),
      ...
      {
        contentInDetails: 'Хакеры атакуют уже не в первый раз',
        imgSrc: getRandomNewsPic(),
        channelLogoSrc: getRandomChannelLogo(),
    ...
    TOURISM: [
      {
        contentInDetails: `Для прошедшей накануне кибератаки хакеры создали тысячи поддельных интернет-страниц туристических компаний, чтобы украсть данные банковских карт плательщиков.`,
        imgSrc: getRandomNewsPic(),
        channelLogoSrc: getRandomChannelLogo(),
      ...
      {
        contentInDetails: `Чтобы собирать персональные данные плательщиков, хакеры сделали поддельные интернет-страницы туристических компаний.`,
        imgSrc: getRandomNewsPic(),
        channelLogoSrc: getRandomChannelLogo(),
        title:
          'Киберпреступники выложили в сеть документы тысяч обманутых туристов',
        date: formatedDate,
        fullDate: date,
      },
      {
    ...
    FINANCE_SYSTEM: [
      {
        contentInDetails: `Группировка хакеров-вымогателей атаковала подразделения пяти крупнейших банка на всех континентах сразу. Убытки исчисляются сотнями миллионов долларов.`,
        imgSrc: getRandomNewsPic(),
        channelLogoSrc: getRandomChannelLogo(),
        title: `Хакеры атаковали крупнейшие банки мира`,
        date: formatedDate,
        fullDate: date,
      },
      {
        contentInDetails: `Международные финансовые организации вынуждены работать в ручном режиме из-за кибератаки банды вымогателей на крупного  разработчика ПО.`,
        imgSrc: getRandomNewsPic(),
        channelLogoSrc: getRandomChannelLogo(),
        title:
          'Кибератака «заморозила» миллиарды — финансисты  приостановили транзакции',
        date: formatedDate,
        fullDate: date,
      },
      {
        contentInDetails:
          'И это только в минувшем квартале. Повышенная активность хакеров может связать с общим ростом деловой активности на крипторынке',
        imgSrc: getRandomNewsPic(),
        channelLogoSrc: getRandomChannelLogo(),
        title: `Хакеры украли миллиард $ в криптовалюте`,
        date: formatedDate,
        fullDate: date,
      },
    ],
    ENERGY: [
      {
        contentInDetails: `Хакерская атака угрожает стабильности энергоснабжения`,
        imgSrc: getRandomNewsPic(),
        channelLogoSrc: getRandomChannelLogo(),
      ...
      {
        contentInDetails: `Жителям угрожает энергетическая катастрофа`,
        imgSrc: getRandomNewsPic(),
        channelLogoSrc: getRandomChannelLogo(),
...
const proccessNewsData = (
  ...
  if (industries.includes('COMPANY_TOP_CAPITALIZATION')) {
    topCapitalizationNews = [
      ...getTopCapitalizationNews(topCapitalizationSector, date),
    ];
  }

  const newsData: INewsObj = getNewsData(
    countries,
    date,
    topCapitalizationNews
  );
