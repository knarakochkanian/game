      ...
      <div className={styles.onboardingButtons}>
        <Modal isOpen={modalOpen2} onClose={closeModal} counter={2}>
          ...
          <div className="ModalButtons">
            ...
            <button className="ModalButton2" onClick={closeModal2}>
              пропустить
            </button>
          </div>
        </Modal>
        ...
        >
          ...
          <div className="ModalButtons">
            ...
            <button className="ModalButton2" onClick={closeModal3}>
              пропустить
            </button>
          </div>
        </Modal>
      ...
      <div className={styles.onboarding}>
        <Modal isOpen={modalOpen} onClose={closeModal} counter={1}>
          ...
          <div className="ModalButtons">
            ...
            <button className="ModalButton2" onClick={closeModal}>
              пропустить
            </button>
          </div>
        </Modal>
